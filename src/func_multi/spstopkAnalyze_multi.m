function [spsRate, neuronSpsCell] = spstopkAnalyze_multi(all_neuronSpsScoreCell, repTimes, topk, networkStru)
    ...
    for mut = 1:numel(all_neuronSpsScoreCell)
        ...
        neuronSpsCell{1,mut}.bugNum = all_neuronSpsScoreCell{mut}.bugNum;
    end
